const WELLAP_CONTENT = {
  ...
  "brandMark": "WA",
  "description": "以 WELL v2 與 WELL AP 考試藍圖建立健康建築認證的核心概念學習路徑，涵蓋 11 個 Knowledge Domains 與 Innovation。",
  "hero": {
    "title": "用<em>三個問題</em>，把 WELL<br>從條文變成你的設計直覺。",
    "lede": "核心概念（What / Why / How）→ 爭議（設計取捨辯證）→ 鑑別（高鑑別考題）。不背 WELL v2 條文，而是能上考場、上專案會議的理解。"
  },
  "moduleListIntro": "依 WELL AP 11 個 Knowledge Domains 加 Innovation 概念整理，每個模組都以三問法拆解 WELL v2 核心概念。",
  "levels": [
    {
      "id": "ap",
      "name": "WELL AP",
  ...
  "modules": [
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "優先自然通風與可開窗",
            "args": [
              "可增加 occupant control、連結戶外環境，並在合適天氣下提高新鮮空氣供應。",
              "對低污染、溫和氣候基地，可降低對機械系統的完全依賴。"
            ]
          },
          "sideB": {
            "label": "優先機械通風與過濾",
            "args": [
              "當 outdoor PM2.5 或交通污染偏高，機械通風可搭配 filtration 與 monitoring 控制進氣品質。",
              "ASHRAE 62.1 路徑與性能測試較容易形成可驗證的合規證據。"
            ]
          },
        ...
        },
        {
          ...
          "sideA": {
            ...
            "args": [
              "可降低工期延誤與臨時設備成本。",
              "若後續再做清潔與測試，短期看似不影響交付。"
            ]
          },
          "sideB": {
            "label": "維持施工污染控制",
            "args": [
              "PM10、VOCs 與濕氣污染一旦進入材料或風管，後續 remediation 成本可能更高。",
              "A04 的重點是生命週期前段預防，而不只是交屋前補救。"
            ]
          },
      ...
      "debates": [
        {
          ...
          "sideA": {
            ...
            "args": [
              "資本支出明確，對短期認證排程較容易管理。",
              "若污染源固定，處理設備可能足以把參數壓回門檻內。"
            ]
          },
          "sideB": {
            "label": "建立持續監測與管理",
            "args": [
              "水質會受停滯、管線、溫度與運維影響，W03/W05 強調 protocols 與 ongoing management。",
              "接近門檻的參數需要 corrective actions 與文件化紀錄。"
            ]
          },
    ...
    },
    {
      ...
      "frameworks": [
        ...
        },
        {
          ...
          "covers": [
            ...
            "N12 Food Production",
            "certified organic and certified sustainable foods"
          ]
        }
      ],
      "debates": [
        {
          ...
          "sideA": {
            "label": "強化標示即可",
            "args": [
              "N02/N07 可提升 informed choice 與 food literacy。",
              "保留選擇自由，較不容易引發員工反感。"
            ]
          },
          "sideB": {
            "label": "改變陳列與廣告",
            "args": [
              "N04 Food Advertising 與 N08 Mindful Eating 關注 design、messaging 與 eating environment。",
              "真實行為常受預設位置、視覺提示與環境干擾影響。"
            ]
          },
      ...
      "questions": [],
      "reinforcement": [],
      "lecturePage": "M03-nourishment.html"
    },
    {
      "id": "M04",
      "name": "光 Light",
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "提高日光與視野",
            "args": [
              "日光與 views 可支援 circadian and psychological health。",
              "daylight simulation 可展示較高的室內日光覆蓋。"
            ]
          },
          "sideB": {
            "label": "控制眩光與視覺舒適",
            "args": [
              "眩光會破壞 visual comfort，可能導致使用者長期拉上遮陽而抵消日光效益。",
              "L04/L07 要求照明環境平衡，而不只是更多光。"
            ]
          },
      ...
      "frameworks": [
        ...
        },
        {
          ...
          "covers": [
            ...
            "at least 25% of all workstations",
            "neutral posture",
            "ergonomics"
          ]
        },
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "先買設備",
            "args": [
              "V02/V07 的工作站與 active furnishings 可直接改變久坐姿勢與工作環境。",
              "硬體改善較容易在 documentation 中被盤點。"
            ]
          },
          "sideB": {
            "label": "先做行為方案",
            "args": [
              "V06/V09 可用活動機會、誘因與監測推動習慣改變。",
              "沒有文化與使用支持，設備可能閒置。"
            ]
          },
      ...
      "debates": [
        {
          ...
          "sideA": {
            ...
            "args": [
              "運維簡單，能源模型與設備控制較穩定。",
              "若符合 T01 基本條件，可先達到多數人可接受的熱環境。"
            ]
          },
          "sideB": {
            "label": "增加分區與個人控制",
            "args": [
              "T03/T04 承認 thermal preferences 高度個人化。",
              "熱舒適不只空氣溫度，還受 clothing、metabolism、radiant temperature 與 air speed 影響。"
            ]
          },
      ...
      "debates": [
        {
          ...
          "sideA": {
            ...
            "args": [
              "過高背景噪音會干擾專注、滿意度與健康。",
              "S02 要控制 HVAC、外部侵入與其他噪音源。"
            ]
          },
          "sideB": {
            "label": "導入最低背景聲",
            "args": [
              "S06 認為穩定 background sound 可改善 signal-to-noise ratio 與 speech privacy。",
              "過低的背景聲會讓語音更容易被理解。"
            ]
          },
    ...
    },
    {
      ...
      "debates": [
        {
          ...
          "sideA": {
            ...
            "args": [
              "可降低缺料與延誤風險。",
              "若材料看似常規產品，短期文件蒐集成本可能超過專案預算。"
            ]
          },
          "sideB": {
            "label": "堅持透明與限制",
            "args": [
              "Materials 考點重視 hazardous ingredients、VOCs 與供應鏈文件。",
              "缺文件會讓 compliance assessment 與第三方審查失去依據。"
            ]
          },
      ...
      "questions": [],
      "reinforcement": [],
      "lecturePage": "M08-materials.html"
    },
    {
      "id": "M09",
      "name": "心理 Mind",
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "先改善空間",
            "args": [
              "M02/M07 可透過 nature、place 與 restorative spaces 降低 mental fatigue。",
              "空間改善可見度高，容易讓 occupants 感受到改變。"
            ]
          },
          "sideB": {
            "label": "先補政策與服務",
            "args": [
              "M01/M03/M05 要求 programs、policies、resources 與 stress management plan。",
              "若壓力源來自制度，單靠美化空間無法處理根因。"
            ]
          },
    ...
    },
    {
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "採用全球一致政策",
            "args": [
              "一致格式便於 documentation、治理與內部稽核。",
              "核心福利與基本 emergency preparedness 可快速展開。"
            ]
          },
          "sideB": {
            "label": "依使用者與在地風險調整",
            "args": [
              "C04/C05 occupant surveys 可揭露不同族群的真實需求。",
              "C12/C13 強調 diversity、inclusion 與 universal design，不能只靠總部模板。"
            ]
          },
      ...
      "questions": [],
      "reinforcement": [],
      "lecturePage": "M10-community.html"
    },
    {
      "id": "M11",
      ...
      "frameworks": [
        {
          ...
          "covers": [
            ...
            "WELL project administrator",
            "WELL Coaching support team"
          ]
        },
        {
          "id": "M11_F2",
        ...
        },
        {
          ...
          "covers": [
            ...
            "recertification",
            "I01 Innovate WELL",
            "I02 WELL Accredited Professional"
          ]
        },
        {
          "id": "M11_F5",
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "追求單案高等級",
            "args": [
              "單案 WELL Gold 或 WELL Platinum 具明確示範效果。",
              "資源集中，documentation 與 Performance Verification 較容易控管。"
            ]
          },
          "sideB": {
            "label": "轉向 Portfolio 擴散",
            "args": [
              "Portfolio 可把策略、文件尺度與 review process 擴展到多資產。",
              "對企業健康策略，覆蓋更多 occupants 可能比單案分數更有價值。"
            ]
          },
        ...
        },
        {
          ...
          "sideA": {
            "label": "堅持標準路徑",
            "args": [
              "審查邏輯清楚，與既有 feature language 對齊。",
              "可降低額外解釋與審查往返風險。"
            ]
          },
          "sideB": {
            ...
            "args": [
              "AAP 可回應在地法規、產品與運維條件差異。",
              "若能證明 intent 與 health outcome 等同，可能比硬套標準更合理。"
            ]
          },
      ...
      "questions": [],
      "reinforcement": [],
      "lecturePage": "M11-certification.html"
    },
    {
      "id": "M12",
      "name": "創新 Innovation",
      ...
      "frameworks": [
        ...
        },
        {
          ...
          "covers": [
            "I02 WELL Accredited Professional",
            "I03 Experience WELL Certification",
      ...
      "debates": [
        {
          ...
          "sideA": {
            "label": "走 I01 自提創新",
            "args": [
              "可針對專案獨特健康議題量身設計，建立差異化示範價值。",
              "若提案被 IWBI 接受，最多可貢獻 10 分。"
            ]
          },
          "sideB": {
            "label": "採用 I04/I05 既有路徑",
            "args": [
              "green building rating 或 wellness program 多已在進行，文件成本低、結果可預期。",
              "不需經過 IWBI 提案審查的不確定性，落地風險小。"
            ]
          },
        ...
        },
        {
          ...
          "sideA": {
            "label": "視為流程加速器",
            "args": [
              "WELL AP 熟悉 feature 門檻與 verification，能 streamline 認證流程、減少退件。",
              "1 分之外更大的價值在專案規劃階段的決策品質。"
            ]
          },
          "sideB": {
            "label": "視為單純計分項",
            "args": [
              "若團隊已有充足 WELL 經驗，I02 的 1 分邊際效益有限。",
              "資源可投入分數更高的 optimization features。"
            ]
          },
      ...
      "questions": [],
      "reinforcement": [],
      "lecturePage": "M12-innovation.html"
    }
  ],
  "lectureBaseUrl": "lectures/",
  "lecturePages": {
    "A": "M01-air.html",
    "W": "M02-water.html",
    "N": "M03-nourishment.html",
    "L": "M04-light.html",
    "V": "M05-movement.html",
    "T": "M06-thermal.html",
    "S": "M07-sound.html",
    "X": "M08-materials.html",
    "M": "M09-mind.html",
    "C": "M10-community.html",
    "I": "M12-innovation.html"
  },
  "firebase": {
